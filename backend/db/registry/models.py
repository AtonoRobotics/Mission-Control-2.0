...
class Recording(Base):
    ...
    storage_type: Mapped[str] = mapped_column(String(32), nullable=False, server_default="local")
    status: Mapped[str] = mapped_column(String(32), nullable=False, server_default="recording")
