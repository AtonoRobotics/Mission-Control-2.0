"""
Alembic environment — Mission Control Registry DB.
...
from db.registry.models import Base  # noqa: E402
...
db_url = os.environ.get("MC_REGISTRY_DB_URL", config.get_main_option("sqlalchemy.url"))
if db_url:
